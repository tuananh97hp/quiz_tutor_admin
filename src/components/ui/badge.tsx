  ...
  'inline-flex items-center rounded-md text-xs font-medium ring-1 ring-inset w-fit',
  {
    variants: {
      variant: {
        ...
        outline:
          'bg-transparent text-gray-700 ring-gray-400 dark:text-gray-300 dark:ring-gray-400/20',
        highlight:
          'bg-pink-50 text-pink-700 ring-pink-600/20 dark:bg-pink-400/10 dark:text-pink-400 dark:ring-pink-500/20',
        contrast:
          'bg-zinc-200 text-black ring-gray-500 dark:bg-zinc-600 dark:text-white dark:ring-gray-700',
      },
      size: {
