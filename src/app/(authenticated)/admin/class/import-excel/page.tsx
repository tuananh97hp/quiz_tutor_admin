...
import { ClassImportForm } from '@/components/(authenticated)/admin/class/class-import-form';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Admin | Nhập Lớp Từ Excel',
};

const ClassImportExcelPage = () => {
  return (
    <div className="mx-auto w-full max-w-screen-2xl px-4 md:px-8">
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-x-4 gap-y-8">
        <div className="flex flex-row items-center">
          ...
          <h1 className="text-4xl font-semibold">Nhập Lớp Từ Excel</h1>
        </div>
...
export default ClassImportExcelPage;
