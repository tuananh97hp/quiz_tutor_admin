...
import { PaymentForm } from '@/components/(authenticated)/admin/payment/payment-form';
...
export const metadata: Metadata = {
  title: 'Admin | Giáo Viên Thanh Toán',
};
    ...
    <div className="mx-auto w-full max-w-screen-2xl px-4 md:px-8">
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-x-4 gap-y-8">
        <div className="flex flex-row items-center">
          ...
          <h1 className="text-4xl font-semibold">Giáo Viên Thanh Toán</h1>
        </div>
