...
import { TeacherImportForm } from '@/components/(authenticated)/admin/teachers/teacher-import-form';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Admin | Nhập Giáo Viên Từ Excel',
};

const TeacherImportExcelPage = () => {
  return (
    <div className="mx-auto w-full max-w-screen-2xl px-4 md:px-8">
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-x-4 gap-y-8">
        <div className="flex flex-row items-center">
          ...
          <h1 className="text-4xl font-semibold">Nhập Giáo Viên Từ Excel</h1>
        </div>
...
export default TeacherImportExcelPage;
