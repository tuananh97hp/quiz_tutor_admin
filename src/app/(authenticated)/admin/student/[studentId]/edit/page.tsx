...
import { StudentForm } from '@/components/(authenticated)/admin/students/student-form';
import StudentService from '@/services/StudentService';
import { getCurrentAccessToken } from '@/utils/session';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Admin | Chỉnh Sửa Học Sinh',
};
      ...
      <div className="mx-auto w-full max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-x-4 gap-y-8">
          <div className="flex flex-row items-center">
            ...
            <h1 className="text-4xl font-semibold">Chỉnh Sửa Học Sinh</h1>
          </div>
